...
public class WheelView extends View {
	...
	// Wheel Values
	private IOnWheelAdapter adapter = null;
	...
	// Listeners
	private List<IOnWheelChanged> changingListeners = new LinkedList<IOnWheelChanged>();
	private List<IOnWheelScroll> scrollingListeners = new LinkedList<IOnWheelScroll>();
	 ...
	 * @return the adapter
	 */
	public IOnWheelAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(IOnWheelAdapter adapter) {
	 ...
	 *            the listener
	 */
	public void addChangingListener(IOnWheelChanged listener) {
	 ...
	 *            the listener
	 */
	public void removeChangingListener(IOnWheelChanged listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (IOnWheelChanged listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(IOnWheelScroll listener) {
	 ...
	 *            the listener
	 */
	public void removeScrollingListener(IOnWheelScroll listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (IOnWheelScroll listener : scrollingListeners) {
	...
	private int getMaxTextLength() {
		IOnWheelAdapter adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
